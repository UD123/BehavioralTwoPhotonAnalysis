classdef TPA_MultiTrialBehaviorClassifier
    % TPA_MultiTrialBehaviorClassifier - detects ROIs automatically using CDNN
    ...
    methods
        ...
        % ==========================================
        % Constructor
        function obj = TPA_MultiTrialBehaviorClassifier()
            % TPA_MultiTrialBehaviorClassifier - constructor
            % Input:
        ...
        function [dbTrain,dbTest] = PrepareLabelerData(obj, dataType)
            ...
            switch dataType
                ...
                case 11 % Technion
                    k = 1;
                    dbStr(k).Path        = 'C:\LabUsers\Uri\Projects\Maria\DendritesTwoPhoton\TwoPhotonData\GroundTruthSession_D8_0802_LabelData.mat';
                ...
                case 12 % Technion
                    k = 1;
                    dbStr(k).Path        = 'C:\LabUsers\Uri\Data\Janelia\Videos\D10\8_6_14\Basler_06_08_2014_d10_001\movie_comb_LabelData.mat';
                    k = 2;
                    dbStr(k).Path        = 'C:\LabUsers\Uri\Data\Janelia\Videos\D10\8_6_14\Basler_06_08_2014_d10_001\movie_comb_LabelData.mat';
                    k = 3;
                    dbStr(k).Path        = 'C:\LabUsers\Uri\Data\Janelia\Videos\D10\8_6_14\Basler_06_08_2014_d10_004\movie_comb_LabelData.mat';
    ...
    methods
        ...
        function obj = tbdSetImageData(obj,imgData)
        ...
        % ==========================================
        % Load vidoe data
        function [obj, imgData] = tbdLoadImageData(obj,fileDirName)
        ...
        function dataOut    = tbdJitterTransform(obj,sigLoad,maxLen,sigLabel,repeatNum)
            % Input:
        ...
        function obj = tbdLoadSimlpeDataset(obj,dataType)
            % Input:
        ...
        function cellData = tbdLoadDatabase(obj, dbType)
...
%            [filePath,fileName,fileExt] = fileparts(mediaInfo.FileName);
            ...
            for fi      = 1:nFrames
                ...
                for k = 1:labelNum
                    ...
                    cData{m,ind+1}      = {mediaInfo.FrameInfo(fi).bboxes{ind}};
                end
    ...
    methods
        ...
        function obj = LoadNetwork(obj,netType)
            ...
            switch netType
                ...
                case 22 % Transfer learning with augement
                ...
                case 25  % DEMOS Vehicle detection
                    ...
                    tempdir = fullfile(obj.SaveDir,'Tmp');
        ...
        % ==========================================
        % Test the networks
        function obj = CreateTrajectories(obj, dataPath)
            % TestNetwork - test rcnn classifier
            % Input:
    ...
    methods
        ...
        function ShowDataSet(obj, setType, figNum, showNum)
            ...
            for k = 1:showNum
                    ...
                    img = insertObjectAnnotation(img, 'Rectangle', box, lbl, 'LineWidth', 8);
                    end
        ...
        % ==========================================
        % Test the networks
        function ShowTrajectories(obj, imgInd)
            % TestNetwork - test rcnn classifier
            % Input:
            %   imgInd     -  image for test
            % Output:
    ...
    methods
        ...
        % ==========================================
        % Testing data load
        function obj = tbdTestLoadImageData(obj, selType)
        ...
        function obj = tbdTestSimpleDataset(obj)
        ...
        function obj = tbdTestAndTrainDigitNetwork(obj)
        ...
        function obj = tbdTestAndTrainDigitNetworkAugemented(obj)
        ...
        function obj = TestAndTrainSessionNetwork(obj, dataType, netType)
            ...
            switch dataType
                case 1
                    dbTrain(1).Path        = 'D:\Uri\Data\Technion\Videos\m8\GroundTruthSession.mat';
                case 101
