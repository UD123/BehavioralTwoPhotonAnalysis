...
classdef TPA_EventManager %< handle
    ...
    properties (Constant)
        ...
        VERSION             = '2501'; % SW version supported
    ...
    properties
        ...
        tInd                = [1 1];           % range location in T stack
...
%         % global constants see Par file
    ...
    methods
        ...
        % =============================================
        function obj = TPA_EventManager(roiType,viewType,Data,hAxes)
            % Constructor
            % init object
...
%         end
        ...
        % =============================================
        function [obj, isOK] = SaveView(obj,viewType)
            % SaveView - copy ROI position to of certain view
            % Input
            %   viewType  - which view of ROI to create
            %   obj         - object with data
            % Output
